...
func (x *ReportRequest_Rule) GetLI() uint32 {
	if x != nil {
		return x.LI
	}
	return 0
...
func (x *ReportRequest_Rule) GetCmpID() uint32 {
	if x != nil {
		return x.CmpID
	}
	return 0
...
const file_base_v1_rpc_report_proto_rawDesc = "" +
	...
	"\x05CmpID\x18\x06 \x01(\rR\x05CmpIDBAB\tMyGaruSDKZ\x2fgithub.com/mygaru/dcr-sdk/gen/base1;base\x92\x03\x02\b\x02b\beditionsp\xe8\a"

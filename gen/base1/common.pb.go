...
const (
	...
	RPCStatus_OUTDATED            RPCStatus = 1
	RPCStatus_ACCESS_DENIED       RPCStatus = 2
	RPCStatus_SERVICE_UNAVAILABLE RPCStatus = 3
)
...
const file_base_v1_common_proto_rawDesc = "" +
	...
	"\x10EVENT_TYPE_CLICK\x10\x04*M\n" +
	"\tRPCStatus\x12\x06\n" +
	"\x02OK\x10\x00\x12\f\n" +
	"\bOUTDATED\x10\x01\x12\x11\n" +
...
var file_base_v1_common_proto_goTypes = []any{
	...
	(RPCStatus)(0),   // 2: common.RPCStatus
}
